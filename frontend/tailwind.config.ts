  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "brand-amber": "hsl(var(--accent-amber))",
        "brand-green": "hsl(var(--accent-green))",
        "brand-purple": "hsl(var(--accent-purple))",
        "brand-gray": "hsl(var(--accent-gray))",
        "sap-navy": {
          DEFAULT: "hsl(var(--sap-navy))",
          foreground: "hsl(var(--sap-navy-foreground))",
        },
        "sap-amber": "hsl(var(--sap-amber))",
        primary: {
